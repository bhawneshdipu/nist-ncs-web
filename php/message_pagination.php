...
$sql = "SELECT * FROM user_messages  where (receiver='$name' or sender='$name') ORDER BY msg_time DESC";
...
$str1= '<nav>
            <ul class="pager">';
$str2='<li><a href="./message.php?page=';
$pageno;
$str3='">';
$str3_5='</a>';
$str4='</li>';
...
$stri1='<li><a href="./message.php?page=';
$pageno;
