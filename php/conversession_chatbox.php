<div class=" container-fluid col-xs-12 pre-scrollable " style="max-height: 500px ;overflow-y: scroll" >
    <a class="well well-sm col-xs-12" href="#"><img src="./profile/profile.jpg" class="img-circle" width="25px" height="25px"> Conversession</a>
    <?php

    $str0='<a class="col-xs-12" role="button" href="./conversession.php?r=';
    $val;
    $str1='"><button class=" btn btn-default btn-sm col-xs-12 btn-group-justified" style="white-space: normal;"  value="';
    $val;
    $str2='"><img src="./profile/';
    $img;
    $str3='"  class="col-xs-3  img-circle" width="25px" height="25px" ><p class="text-capitalize col-xs-8 ';
    $cls1='text-primary" ';
    $cls2='text-success" ';
    $cls3='text-danger';
    $cls4='text-warning';
