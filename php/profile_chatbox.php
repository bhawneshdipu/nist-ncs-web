<div class="container-fluid col-xs-12 pre-scrollable " style="max-height: 500px ;overflow-y: scroll"    >
    <a class="container-fluid well well-sm col-xs-12"  href="#"><img src="./profile/profile.jpg" class="img-circle" width="25px" height="25px"> User Profile</a>
    <?php

    $str0='<a class="container-fluid col-xs-12 " role="button" href="./profile.php?p=';
    $val;
    ...
    $img;
    $str3='"  class="container-fluid col-xs-3  img-circle" width="25px" height="25px" ><p class="container-fluid text-capitalize col-xs-8 ';
    $cls1='text-primary" ';
    $cls2='text-success" ';
    $cls3='text-danger';
    $cls4='text-warning';
    ...
    $str5='</p>';
    //$str6='<span class="glyphicon glyphicon-asterisk col-xs-2 text-success"></span>'; for online status, not implemented
    $str7='</button></a>';
