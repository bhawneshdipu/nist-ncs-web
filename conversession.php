...
<head>
    ...
    <script src="./js/msg_receiver_selector.js"></script>
...
<div class="container-fluid" style="margin-top: 55px">
    ...
    <!-- Center Column -->
    <div class="col-sm-7 ">
        <?php include_once ("./php/conversession_alert.php");?>
        <?php include_once ("./php/conversession_msgbox.php");?>

        <?php include_once ("./php/conversession_msgpost.php")?>
        
        <?php include_once ("./php/conversession_panel.php");?>
        <?php include_once ("./php/conversession_pagination.php");?>
    </div>
    <!-- Right Column -->
    <div class="col-sm-3">
        <?php include_once ("./php/conversession_chatbox.php");?>
    </div><!--/Right Column -->
