...
<div class="container-fluid" style="margin-top: 55px">
    ...
    <!-- Center Column -->
    <div class="col-sm-7">
        <?php include_once ("./php/home_alert.php");?>
        <?php include_once ("./php/home_msgbox.php");?>
        <?php include_once ("./php/timeline_panel.php");?>
        <?php include_once("./php/home_pagination.php");?>
    </div>
    <!-- Right Column -->
    <div class="col-sm-3 ">
