    ...
    <div class="col-xs-9">
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="font-family: 'Ubuntu';font-size:x-large">
                <b>"To create an Educational Institute for nurturing Quality Engineers and Managers for growth of Indian Industries, to develop Entrepreneurs and to pursue Innovative Research on Emerging Technologies for the Future Generation."</b>
