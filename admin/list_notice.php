...
$from=$page*15;
$limit=15;
$sql="SELECT * FROM notice_table ORDER BY notice_date DESC LIMIT $limit offset $from";
$result=pg_query($conn,$sql );
echo '   <row>
        <table class="table table-hover">
            <thead>
                <tr>
                    <th class="col-xs-1">Notice ID</th>
                    <th  class="col-xs-2" >Notice Title</th>
                    
                    <th class="col-xs-2" >Notice</th>
                    <th  class="col-xs-2" >Notice Author</th>
...
$sql="select * from notice_table where 1=1";
$result=pg_query($conn,$sql );
$num_rows=ceil(pg_num_rows($result));
$str1= '<nav>
            <ul class="pager">';
$str2='<li><a href="./notice_detail.php?page=';
$pageno;
$str3='">';
$str3_5='</a>';
$str4='</li>';
...
$stri1='<li><a href="./notice_detail.php?page=';
$pageno;
